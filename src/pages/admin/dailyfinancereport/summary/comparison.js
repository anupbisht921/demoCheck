                      ...
                      <div className="card flex items-center">
                          ...
                          <OverlayPanel ref={op} className="chartoptiondropdown">
                            <div className='xl:space-y-[1.250vw] space-y-[22px] xl:p-[0.833vw] p-4'>
                              ...
                              <label htmlFor="username" className='text-[#374151] xl:text-[0.729vw] text-sm font-medium xl:leading-[1.042vw] leading-5'>Group by</label>
                        ...
                        <div className="absolute left-2 top-0">
                          ...
                          <div className=" bg-[#F6F7F9] h-[35vw] xl:p-[0.625vw] p-[15px] mt-4 xl:w-[10.938vw] w-[200px] rounded-lg">
                              ...
                              <ul>
                                  ...
                                  <div className="text-[#363A44] xl:text-[0.729vw] text-[14px] font-medium xl:py-[0.625vw] py-[12px] relative  border-[#a9b9d0] border-y border-dashed">
                                  ...
                                  <li className="timeline__event custom-dropdown">
                                  <div className="text-[#363A44] xl:text-[0.729vw] text-[14px] font-medium xl:py-[0.625vw] py-[12px] border-[#a9b9d0] border-b border-dashed relative">
                                  ...
                                  <Dropdown value={selectedGroup2} onChange={(e) => setSelectedGroup2(e.value)} options={Group2} optionLabel="name" 
                                    placeholder="Second Selecion" className="w-full " />
                                         {
                                      !selectedGroup2?.name == "" ? <div className="absolute top-[34px] right-[15px] bg-[#f5f6f7] cursor-pointer" onClick={()=>setSelectedGroup1()}><i className="alb-trash text-[17px] text-[#4B586E]"></i></div> 
                                      :""
                                    }
                                  </div>
                                  </li>
