        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 xl:gap-[1.250vw] gap-[20px] xl:mt-[2.954vw] mt-[20px] mb-[20px]">
          ...
          <div className="universe-box xl:p-[1.042vw] p-[15px] rounded-lg">
            ...
            <Tabs selectedIndex={activeTab} onSelect={handleTabClick}>
              ...
              >
                <TabList>
                  <div className="flex items-center gap-[60px] lg:gap-[6.188vw] justify-between">
                    <div className="flex gap-2 items-center">
                      <Tab>
                        <div
                          className={`xl:h-[1.658vw] h-[28] xl:px-[0.875vw] px-[18px] lg:py-[0.400vw] py-[8px]  flex items-center
                          ${
                            activeTab === 0
                              ? "bg-[#2F6070] text-white active border border-[#4BA5B7]"
                              : "bg-[#171b1e] opacity-[0.7] dark:bg-[#374151] text-white/70"
                          }
                          border border-[#FFFFFF1A]  lg:text-[0.625vw] text-[12px] text-[#fff] rounded-full font-medium cursor-pointer`}
                        >
                          All
                        </div>
                      </Tab>
                      ...
                      <Tab>
                        <div
                          className={`xl:px-[0.775vw] px-[18px] lg:py-[0.400vw] py-[8px]  lg:text-[0.625vw] text-[12px]  flex items-center
                          ${
                            activeTab === 1
                              ? "bg-[#2F6070] text-white active border border-[#4BA5B7]"
                              : "bg-[#171b1e] dark:bg-[#374151] text-white/70 opacity-[0.7]"
                          }
                      ...
                      <Tab>
                        <div
                          className={`xl:px-[0.775vw] px-[18px] flex items-center lg:py-[0.400vw] py-[8px] lg:text-[0.625vw] text-[12px] 
                          ${
                            activeTab === 2
